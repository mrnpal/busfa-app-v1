...
class _RegisterPageState extends State<RegisterPage> {
  ...
  // final birthPlaceDateController = TextEditingController();
  // final indukNumberController = TextEditingController();
  ...
  Future<void> _register() async {
    if (_formKey.currentState!.validate()) {
      ...
      final result = await registerAlumni(
        ...
        // indukNumber: indukNumberController.text.trim(),
        phone: phoneController.text.trim(),
        // job: jobController.text.trim(),
        // graduationYear: graduationYearController.text.trim(),
        // parentName: parentNameController.text.trim(),
        // dateEntry: dateEntryController.text.trim(),
        // education: educationController.text.trim(),
        // birthPlaceDate: birthPlaceDateController.text.trim(),
      ...
      if (result == 'Pendaftaran berhasil. Tunggu verifikasi admin.') {
        ...
        // indukNumberController.clear();
        // birthPlaceDateController.clear();
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                //   child: _buildTextField(
                //     controller: indukNumberController,
                //     label: 'Nomor Induk',
